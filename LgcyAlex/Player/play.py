...
import aiofiles
import aiohttp
from LgcyAlex.converter import convert
import ffmpeg
import requests
from Process.fonts import CHAT_TITLE
from PIL import Image, ImageDraw, ImageFont
from LgcyAlex.config import ASSISTANT_NAME, BOT_USERNAME, IMG_1, IMG_2, IMG_5
...
async def generate_cover(thumbnail, title, userid, ctitle):
    ...
    image2 = Image.open("Process/ImageFont/LgcyAlex.png")
    ...
    font = ImageFont.truetype("Process/ImageFont/LgcyAlex.ttf", 60)
    font2 = ImageFont.truetype("Process/ImageFont/LgcyAlex.ttf", 70)     
